...
from webapp.main.config import basedir


class TestDevelopmentConfig(TestCase):
    def create_app(self):
        app.config.from_object('webapp.main.config.DevelopmentConfig')
        return app
...
class TestProductionConfig(TestCase):
    def create_app(self):
        app.config.from_object('webapp.main.config.ProductionConfig')
        return app
